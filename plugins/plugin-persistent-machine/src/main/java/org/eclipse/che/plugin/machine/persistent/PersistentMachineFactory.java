 ...
 */
public interface PersistentMachineFactory {
     ...
     */
    PersistentMachineInstance createInstance(@Assisted Machine machine,
                                             @Assisted SshClient sshClient,
                                             @Assisted LineConsumer outputConsumer) throws MachineException;

    /**
     * Creates persistent machine implementation of {@link org.eclipse.che.api.machine.server.spi.InstanceProcess}.
     *
     ...
     */
    PersistentMachineProcess createInstanceProcess(@Assisted Command command,
