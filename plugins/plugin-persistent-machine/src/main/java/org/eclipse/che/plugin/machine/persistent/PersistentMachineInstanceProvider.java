...
/**
 * Implementation of {@link InstanceProvider} based on persistent machine.
 *
 * <p>Persistent machine can't be actually created and exists somewhere outside of the control.<br>
...
public class PersistentMachineInstanceProvider implements InstanceProvider {
    ...
    private final PersistentMachineFactory persistentMachineFactory;

    @Inject
    public PersistentMachineInstanceProvider(PersistentMachineFactory persistentMachineFactory) throws IOException {
        this.persistentMachineFactory = persistentMachineFactory;
